...
/**
 * Android SQLite-Connector helper class
 */
class SQLiteConnectorHelper extends DBHelper
{
    ...
    void open(File dbFile) throws Exception {
        db = connector.newSQLiteConnection(dbFile.getAbsolutePath(),
    ...
    private JSONObject executeSQLiteStatement(String query, JSONArray paramsAsJson,
        ...
        SQLiteStatementInterface myStatement = db.prepareStatement(query);
